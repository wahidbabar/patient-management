...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        DatabaseInstance authServiceDbInstance = createDatabaseInstance("AuthServiceDB", "auth-service-db");
        DatabaseInstance patientServiceDbInstance = createDatabaseInstance("PatientServiceDB", "patient-service-db");

        CfnHealthCheck authDbHealthCheck = createDbHealthCheck(authServiceDbInstance, "AuthServiceDbHealthCheck");
        CfnHealthCheck patientDbHealthCheck = createDbHealthCheck(patientServiceDbInstance, "PatientServiceDbHealthCheck");
        ...
        FargateService authService = createFargateService("AuthService",
                "auth-service",
                List.of(4005),
                authServiceDbInstance,
                Map.of("JWT_SECRET", "4AisO5lcOsv65qCk7x+FSSqV0MxbRvHNlW20AJUu+/o=")
        );

        authService.getNode().addDependency(authServiceDbInstance);
        ...
        FargateService patientService = createFargateService("PatientService",
                "patient-service",
                List.of(4000),
                patientServiceDbInstance,
                Map.of("BILLING_SERVICE_ADDRESS", "host.docker.internal",
                        "BILLING_SERVICE_GRPC_PORT", "9001")
        );

        patientService.getNode().addDependency(patientServiceDbInstance);
